...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeCryptoFocusAmount"))
        settings.setValue("nAnonymizeCryptoFocusAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeCryptoFocusAmount = settings.value("nAnonymizeCryptoFocusAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeCryptoFocusAmount"))
        SoftSetArg("-anonymizecryptofocusamount", settings.value("nAnonymizeCryptoFocusAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeCryptoFocusAmount:
            nAnonymizeCryptoFocusAmount = value.toInt();
            settings.setValue("nAnonymizeCryptoFocusAmount", nAnonymizeCryptoFocusAmount);
            emit anonymizeCryptoFocusAmountChanged(nAnonymizeCryptoFocusAmount);
            break;
        default:
            break;
        }
