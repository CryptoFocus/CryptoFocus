...
void ThreadIRCSeed()
{
    ...
    RenameThread("cryptofocus-ircseed");
...
void ThreadIRCSeed2()
{
	...
	int ntimeout = 1000;
        ...
        if (TestNet())
        {
            Send(hSocket, "JOIN #cryptofocuscoinTEST\r");
            Send(hSocket, "WHO #cryptofocuscoinTEST\r");
        } else
        {
	    LogPrintf("JOIN #cryptofocuscoin\n");
            // randomly join #cryptofocuscoin00-#cryptofocuscoin05
            //int channel_number = GetRandInt(5);

            // Channel number is always 0 for initial release
            int channel_number = 0;
            Send(hSocket, strprintf("JOIN #cryptofocuscoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #cryptofocuscoin%02d\r", channel_number).c_str());
        };
